...
gdalbuildvrt(gdalfile=paste("C:/Koma/00_AndrasProjekt/lidar/balaton/",file.names,sep=""),output.vrt=output.vrt)
...
raster=stack("C:/Koma/00_AndrasProjekt/lidar/balaton/pt_24_25.tif")
raster2=stack("C:/Koma/00_AndrasProjekt/lidar/balaton/pt000024merged.grd")

names(raster) <- names(raster2)

writeRaster(raster,"C:/Koma/00_AndrasProjekt/lidar/balaton/pt_24_25_merged.grd",overwrite=TRUE)
