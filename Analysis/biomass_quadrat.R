...
# after multicollinearity check c(18+2,26+2,14+2,11+2)
...
mlm.fit_leafoff=lm(total.weight~.,data=lidar_wpointsfield[lidar_wpointsfield$season=="leafoff",c(18+2,26+2,14+2,11+2,7)])
...
rf.fit_leafoff <-  train(total.weight ~.,
                         data = lidar_wpointsfield[lidar_wpointsfield$season=="leafoff",c(18+2,26+2,14+2,11+2,7)],
                         method = "rf",
                         metric = "RMSE",
                         importance=TRUE,
                         ntree=100,
