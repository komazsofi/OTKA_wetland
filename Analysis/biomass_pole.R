...
rf=randomForest(x=lidar_wpointsfield[(lidar_wpointsfield$season=="leafoff"),10:44],y=lidar_wpointsfield[(lidar_wpointsfield$season=="leafoff"),50])
varImpPlot(rf)

#select first 10 most important c(10,15,16,18,25,26,14,29,11,23)
v=vifcor(lidar_wpointsfield[,c(15,16,18,25,26,14,29,11,23)],th=0.6)
v

# after multicollinearity check c(18,26,14,11)
...
mlm.fit_leafoff=lm(sum_pole_contact ~.,data=lidar_wpointsfield[lidar_wpointsfield$season=="leafoff",c(18,26,14,11,50)])
summary(mlm.fit_leafoff)
stargazer(mlm.fit_leafoff,type="text")

mlm.fit_leafon=lm(sum_pole_contact ~.,data=lidar_wpointsfield[lidar_wpointsfield$season=="leafon",c(18,26,14,11,50)])
summary(mlm.fit_leafon)
stargazer(mlm.fit_leafon,type="text")

mlm.fit_balaton=lm(sum_pole_contact ~.,data=lidar_wpointsfield[lidar_wpointsfield$lake=="balaton",c(18,26,14,11,50)])
summary(mlm.fit_balaton)
stargazer(mlm.fit_balaton,type="text")

mlm.fit_ferto=lm(sum_pole_contact ~.,data=lidar_wpointsfield[lidar_wpointsfield$lake=="ferto",c(18,26,14,11,50)])
summary(mlm.fit_ferto)
stargazer(mlm.fit_ferto,type="text")

mlm.fit_tisza=lm(sum_pole_contact ~.,data=lidar_wpointsfield[(lidar_wpointsfield$lake=="tisza"&lidar_wpointsfield$season=="leafoff"),c(18,26,14,11,50)])
...
rf.fit_leafoff <-  train(sum_pole_contact~.,
                         data = lidar_wpointsfield[lidar_wpointsfield$season=="leafoff",c(15,16,18,25,26,14,29,11,23,50)],
                         method = "rf",
                         metric = "RMSE",
                         importance=TRUE,
                         ntree=100,
...
rf.fit_leafon <-  train(sum_pole_contact ~.,
                        data = lidar_wpointsfield[lidar_wpointsfield$season=="leafon",c(15,16,18,25,26,14,29,11,23,50)],
                        method = "rf",
                        metric = "RMSE",
                        importance=TRUE,
                        ntree=100,
...
rf.fit_balaton <-  train(sum_pole_contact ~.,
                         data = lidar_wpointsfield[lidar_wpointsfield$lake=="balaton",c(15,16,18,25,26,14,29,11,23,50)],
                         method = "rf",
                         metric = "RMSE",
                         importance=TRUE,
                         ntree=100,
...
rf.fit_ferto <-  train(sum_pole_contact ~.,
                       data = lidar_wpointsfield[lidar_wpointsfield$lake=="ferto",c(15,16,18,25,26,14,29,11,23,50)],
                       method = "rf",
                       metric = "RMSE",
                       importance=TRUE,
                       ntree=100,
...
rf.fit_tisza <-  train(sum_pole_contact ~.,
                       data = lidar_wpointsfield[(lidar_wpointsfield$lake=="tisza"&lidar_wpointsfield$season=="leafoff"),c(15,16,18,25,26,14,29,11,23,50)],
                       method = "rf",
                       metric = "RMSE",
                       importance=TRUE,
                       ntree=100,
